  ...
  await prisma.ressource.createMany({
    data: [
      ...
      // -------------------------
      {
        ...
        contenu: "Technique de respiration guidée pour réduire l’anxiété rapidement.",
      ...
      },
      {
        ...
        contenu: "Séquence d’étirements pour détendre le corps avant de dormir.",
      ...
      },
      {
        ...
        contenu: "Article expliquant les causes de l’insomnie et les solutions.",
      ...
      },
      {
        ...
        contenu: "Conseils pour optimiser sa chambre et son hygiène de sommeil.",
      ...
      },
      {
        ...
        contenu: "Exercice rapide pour se recentrer pendant une journée chargée.",
      ...
      },
      {
        ...
        contenu: "Audio de méditation douce pour traverser les émotions difficiles.",
